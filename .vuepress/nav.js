        ...
        items: [{
            ...
            },
            {
                ...
                items: [
                    ...
                    { text: '微信小程序开发资源', link: 'https://github.com/justjavac/awesome-wechat-weapp' },
                    { text: 'Vue渲染器源码解析文档', link: 'http://hcysun.me/vue-design/zh/' },
                    { text: 'Vue源码解析文档', link: 'https://ustbhuangyi.github.io/vue-analysis/' }
                ]
            },
            {
                text: '资源书籍',
                items: [
                    { text: '软件合集', link: 'https://github.com/91CL/91CL-Softwares/wiki' },
        ...
        items: [{
            ...
            },
            {
                ...
                items: [
                    ...
                    { text: 'Cutterman-PS切图插件', link: 'http://www.cutterman.cn/zh/cutterman' },
            ...
            },
            {
                ...
                items: [
                    ...
                    { text: 'Adobe Color CC', link: 'https://color.adobe.com/zh/create/color-wheel' },
                    { text: 'LOLCOLORS', link: 'https://www.webdesignrankings.com/resources/lolcolors' },
                    { text: '随机COLOR', link: 'http://color.aurlien.net/' },
                    { text: '渐变配色uigradients', link: 'https://uigradients.com/' },
                    { text: '渐变配色bestvist', link: 'https://www.bestvist.com/css-gradient' },
            ...
            },
            {
                ...
                items: [
                    ...
                    { text: 'Prettier - Playground 代码在线格式化', link: 'https://prettier.io/playground/' }
                ]
            },
            {
                text: '组件图标',
            ...
            },
            {
                text: '浏览器及插件',
                items: [
                    { text: 'FeHelper-WEB开发助手', link: 'https://chrome.google.com/webstore/detail/fehelper%E5%89%8D%E7%AB%AF%E5%8A%A9%E6%89%8B/pkgccpejnmalmdinmhkkfafefagiiiad' },
                    { text: 'Octotree-Github项目结构树', link: 'https://chrome.google.com/webstore/detail/octotree/bkhaagjahfmjljalopjnoealnfndnagc' },
                    { text: 'Postman-API测试神器', link: 'https://chrome.google.com/webstore/detail/postman/fhbjgbiflinjbdggehcddcbncdddomop' },
                    { text: 'Tampermonkey-油猴脚本', link: 'https://chrome.google.com/webstore/detail/tampermonkey/dhdgffkkebhmkfjojejmpbldmpobfkfo' },
                    { text: 'Ghelper-谷歌上网助手', link: 'http://googlehelper.net/' },
                    { text: 'Astar VPN', link: 'https://chrome.google.com/webstore/detail/astar-vpn-free-and-fast-v/jajilbjjinjmgcibalaakngmkilboobh?hl=zh-CN' },
                    { text: 'IG谷歌访问助手', link: 'https://iguge.app/' },
                    { text: '谷歌访问助手破解版', link: 'https://github.com.cnpmjs.org/wuxiumu/Google-Browser-Assistant' }
                ]
            }
        ]
    },
