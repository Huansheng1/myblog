...
1. 进入[登录地址](https://account.aliyun.com/login/login.htm)并进行帐号密码登录
2. 系統我们推荐选择`CentOS8`:![](https://gitee.com/huanshenga/myimg/raw/master/PicGo/20210307155840.png)

## 登录服务器并安装Node

01. 通过 服务器公网IP 连接服务器：`ssh root@xxx.xxx.xxx`

2. 测试当前我们的服务器是否集成了`dnf`包管理工具：![](https://gitee.com/huanshenga/myimg/raw/master/PicGo/20210307121847.png)

3. 由于我们当前系统没有，我们来安装一下 `dnf` ：`yum install dnf` (中途可能会需要你输入，直接`y`就行)

4. 搜索是否存在`nodejs`包：`dnf search nodejs` ![](https://gitee.com/huanshenga/myimg/raw/master/PicGo/20210307122459.png)

5. 查看当前`nodejs`详细信息，发现版本好像有点老：![](https://gitee.com/huanshenga/myimg/raw/master/PicGo/20210307122603.png)

6. 对比下[`nodejs`官网](https://nodejs.org/zh-cn/)的当前版本：![](https://gitee.com/huanshenga/myimg/raw/master/PicGo/20210307123403.png)，但我们仍然需要先安装它，至于为什么下面会提到：`dnf install nodejs`
...
![](https://gitee.com/huanshenga/myimg/raw/master/PicGo/20210307120136.png)
...
1. 选择本地数据库的数据表右键导出`.sql`文件：![](https://gitee.com/huanshenga/myimg/raw/master/PicGo/20210307175814.png)
2. 选择服务器数据库右键执行`sql`文件导入数据表：![](https://gitee.com/huanshenga/myimg/raw/master/PicGo/20210307175902.png)
...
点击终端你会发现 等于我们直接通过 `ssh` 操控远程服务器了，是不是很舒服：![](https://gitee.com/huanshenga/myimg/raw/master/PicGo/20210307193831.png)
...
6. 我们可以通过`http://服务器公网Ip:8080`访问到`jenkins`并进行相应设置：![](https://gitee.com/huanshenga/myimg/raw/master/PicGo/20210307235134.png)

7. 再开一个终端`ssh`连接服务器，输入：`cat /root/.jenkins/secrets/initialAdminPassword`来查看密码：![](https://gitee.com/huanshenga/myimg/raw/master/PicGo/20210307235432.png)
...
9. 设置用户名与密码：![](https://gitee.com/huanshenga/myimg/raw/master/PicGo/20210308000316.png)
...
1. 点击 `新建任务`：![](https://gitee.com/huanshenga/myimg/raw/master/PicGo/20210308235456.png)
2. 选择 第一个即可：![](https://gitee.com/huanshenga/myimg/raw/master/PicGo/20210308235555.png)
